...
public class BaseSQLite extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_RUN = "CREATE TABLE " + TABLE_RUN + " (" + COL_RUN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_RUN_NAME + " TEXT, " + COL_RUN_LOGIN + " TEXT, " + COL_RUN_DIST + " FLOAT);";

    //private static final String CREATE_TABLE_RUN = "CREATE TABLE " + TABLE_RUN + " ("
      //       + COL_RUN_NAME + " TEXT, "+ COL_RUN_DATE +" BLOB, " + COL_RUN_PROFIL + " TEXT, " + COL_RUN_DIST + " REAL," + COL_RUN_VIT + "REAL );";
